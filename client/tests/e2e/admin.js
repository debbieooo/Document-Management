...
//       .pause(2000);
//   },
//   'Admin can search for documents': (browser) => {
//     browser
//       .url('http://localhost:8000/documents')
//       .waitForElementVisible('body', 5000)
...
//       .pause(1000)
//       .waitForElementVisible('div.manage-documents', 5000)
//       .waitForElementVisible('#manage-documents', 5000)
//       .setValue('#search', 'Pocahontas')
//       .pause(1000)
//       .waitForElementVisible('#manage-documents', 2000)
//       .click('#manage-users')
//       .waitForElementVisible('#manage-documents', 5000)
//       .pause(2000)
//       .click('#manage-documents')
//       .clearValue('#manage-documents')
//       .pause(2000);
//   },
